...
//a function to be defined to set reviewer rating values in the int reviews[NUM_REVIEWERS][NUM_MOVIES] array
    ...
    //loop until valid rating entered
                do{
                    cout<<"Enter rating for transaction "<<i+1<<", Movie #10"<<j<<"(1-terrible to 5-excellent, 0 -never ordered): ";
                    cin>>rating;
...
//a function to be defined to display current values in the int reviews[NUM_REVIEWERS][NUM_MOVIES] array
    ...
    void showReviewersHighestRating(int **reviews){
...
void reviewGoods(){
    ...
    do
    {
        ...
        cout<<"3. Show a reviewers highest rated frut or vegetable. (enter reviewer# 1-4)"<<endl;
