...
#	https://github.com/lewallep/cs372/blob/master/Proj1/chatclient.py corresponding c or c++ file in that directory
#	https://github.com/reformingpanda/CS372-Assignment1/blob/master/chatclient.py c or c++ file in that directory
#	https://github.com/fedackb/cs372-project1/blob/master/chatclient.py c or c++ file in that directory
#   other references indicated in the code.
*/
...
char serverHandle[510] = "SERVER";	//Used as the handle
char clientMessage[510]; //510 for message and handle
char serverMessage[510];
int listenChat;
int portNumber;
int connectChat;
...
void serverMessage1(){
    ...
    if (validateInput.length() < 500){
            ...
            //send(connectChat, serverMessage, strlen(serverMessage), 0);
            send(connectChat, serverMessage, strlen(serverMessage), 0);
        }
...
void userName(){
    ...
    */
    ...
    int receiveCheck;
	receiveCheck = recv(connectChat, clientMessage, 500, 0);
    // Error encountered
    if (receiveCheck == -1) {
...
void clientMessage1(){
    ...
    */
    //please note that the size of the buffer is 500
	recv(connectChat, clientMessage, 500, 0);
