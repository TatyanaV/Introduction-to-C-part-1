//tatyana vlaskin
//week 10, meet requirements of problems 1-7
//1234567.cpp
...
string removeChar(string str_input);
void stringToLower(string &str_input_nocase);
...
void palindromIterative(){
    ...
    getline(cin, str_input);
    new_str_input = removeChar(str_input);
    stringToLower(new_str_input);
    cout<<"String that you've entered was changed to: " <<new_str_input<<endl;
    if (is_palindrome(new_str_input) == true)
...
cout << "Palindrome Detection Program" << endl;
    ...
    new_str_input = removeChar(str_input);
    stringToLower(new_str_input);
    cout<<"\nString that you've entered was changed to: " <<new_str_input<<endl;
    if ((is_palindrome(new_str_input, 0, new_str_input.length()-1)) == true){
        cout << endl << "Your entry is a palindrome.\n";
    }
    else{
        cout << endl << "Your entry is not a palindrome.\n";
...
void stringToLower(string &str_input_nocase)
{
  ...
  {
    str_input_nocase[i] = tolower(str_input_nocase[i]);
  }
