...
* Week 7, Problem 1
* Description: Self explanatory when you read a code
* Input: Program asks the user to enter an integer
Output:
***********************************************************************
Enter an integer: 15

1. To access the value of a variable directly, type:
cout << variable.
You will get: 15

2. To access the address of a variable with the reference operator, type:
cout << &variable.
You will get: 0x28ff44

3. To access a pointer's value by accessing it directly, type:
cout << pointer.
This is equivalent to accessing the address of the variable with the pointer.
You will get: 0x28ff44

4. To access the value of the pointee by dereferencing a pointer, type:
cout << *pointer.
This is equivalent to accessing the value of a variable.
You will get: 15

5. To access the address of a pointer, type:
cout << &pointer.
You will get: 0x28ff20
