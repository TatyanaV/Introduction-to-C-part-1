...
#	https://github.com/lewallep/cs372/blob/master/Proj1/chatclient.py
#	https://github.com/reformingpanda/CS372-Assignment1/blob/master/chatclient.py
#	https://github.com/fedackb/cs372-project1/blob/master/chatclient.py
#	https://github.com/harmonh/CS-Projects/blob/aed225c31743852393432a7c46411c91968f3b28/Networking_CS372/chatclient.py
#	TCPClient.py function on pages 164-167 from our book "Computer Networking" (Kurose, James F., and Keith W. Ross. Computer Networking:
#	A Top-down Approach. 6th ed. Boston: Pearson, 2013.) -- 80% of the code take from this refference, the rest from the
